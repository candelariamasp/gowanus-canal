var config = {    
    ...
    theme: 'light',
    alignment: 'left',
    toptitle: 'Points Unknown | Mapbox Storytelling | May 8th 2020',
    ...
    chapters: [
        ...
        {//3
            ...
            title: 'Two Polluted Water Bodies',
        ...
        {//4
            id: 'picture2',
            title: "<span class='lighter'>We Love The Gowanus Industrial Past</span>",
            description: "<span class='lighter'>The zone has gotten the attraction of residential and commercial development projects that want to benefit from the industrial character of the area. Click below to listen Lee A. explaining the reason why the Gowanus is so particular.</span>",
        ...
        {//5
            id: 'picture3',
            title: '<span class="lighter">But Little is done to recover its Resilience</span>',
            description: "<span class='lighter'>The area suffers from sewage outfall floods which will be aggravated by the Gowanus densification. There is a projected increase of 1 billion gallons of sewage outfall per year, according to SCAPE. Water quality is poor, and water access limited. Click below to listen to one of its residents talking about neighbors flooded homes.</span>",
        ...
        {//6
            id: 'picture4',
            title: '<span class="lighter">The Newtown Creek Is Not Like the Gowanus</span>',
            description: "<span class='lighter'> The city’s plans are primarily focused on expanding manufacturing alongside Newtown Creek to convert it into the city’s core industrial hub.</span>",
            /*quote: "<span class='below'>“It’s getting more expensive for people that have lived here for generations”</span>",*/
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        ...
        {//9 zoom 1 - NCpopDensity
            ...
            image: 'images/population_density.png',
             /*imageCredit: '<a href="https://www.nytimes.com/2020/04/09/nyregion/coronavirus-queens-corona-jackson-heights-elmhurst.html">The New York Times</a>',*/
            description: 'The low population density near Newtown Creek in this map further reveals the residential aspect as being secondary in this area and how many people are actually living near a toxic water body. In 1990, New York State declared that the water of Newtown Creek was not in compliance with the Clean Water Act standards. Additionally, the EPA Human Health Risk Assessment advised against eating contaminated fish from the Creek. As part of the City’s cleaning efforts, the Newtown Creek Wastewater Treatment plant was upgraded in 2012, whose origins date back to the 1970s right after the Greenpoint oil spill.',
            location: {
                center: [-73.961541, 40.727570],
                zoom: 13.5,
                //pitch: 40,
        ...
        {//10 zoom 1 - NCresidential
            id: 'NCresidential',
            title: 'Newton Creek Residential Area Disconnected From Water Body',
        ...
        {//12
            id: 'picture6',
            title: '<span class="lighter">The Gowanus is Different from nearby neighborhoods</span>',
            description: "<span class='lighter'>It offers low rise, wide, and comfortable spaces, which are appreciated by neighbors. Click to listen one of the residents.</span>",
        ...
        {//15 zoom 2 - GCpopDensity
            id: 'GCpopDensity',
            title: 'Gowanus Canal Dense Area Next to a Toxic Water Body',
            image: 'images/population_density.png', //add NYCHA pic to the side
            /*imageCredit: '<a href="https://www.nytimes.com/2020/04/09/nyregion/coronavirus-queens-corona-jackson-heights-elmhurst.html">The New York Times</a>',*/
        ...
        {//17 zoom 2 - GCnewDevelopment
            id: 'GCnewDevelopment',
            title: 'Gowanus Canal will Densify',
            image: 'images/Gowanus_Rezoning.png', //Add pictures of the plan
            /*imageCredit: '<a href="https://www.nytimes.com/2020/04/09/nyregion/coronavirus-queens-corona-jackson-heights-elmhurst.html">The New York Times</a>',*/
            description: "WIP",
            location: {
                center: [-74.004426, 40.675859],
        ...
        {//18 zoom 2 - GCcso
            ...
            /*imageCredit: '<a href="https://www.nytimes.com/2020/04/09/nyregion/coronavirus-queens-corona-jackson-heights-elmhurst.html">The New York Times</a>',*/
            description: "This are the Combined Sewage Overflow outfalls. WIP.",
            location: {
                center: [-74.004426, 40.675859],
                zoom: 14.5,
                //pitch: 40,
        ...
        {//19 zoom 2 - GCflooding
            id: 'GCflooding',
            title: 'Gowanus Canal will Further Flood',
            /*image: 'images/Chapter_4_Image.jpg', 
            imageCredit: '<a href="https://www.nytimes.com/2020/04/09/nyregion/coronavirus-queens-corona-jackson-heights-elmhurst.html">The New York Times</a>',*/
            description: "This is the projected flooded by FEMA. WIP",
            location: {
                center: [-74.004426, 40.675859],
                zoom: 14.5,
                //pitch: 40,
