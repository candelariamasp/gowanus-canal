var config = {    
    ...
    chapters: [
        ...
        {//9 The Newtown Creek Industrial Past
            ...
            description: "<span class='lighter'> Owing to its location, Newtown Creek developed as a strategic waterway and port that became heavily industrialized in the mid-nineteenth century. It used to be crowded with commercial vessels catering to the more than 50 refineries that would operate on its banks. The neighborhood still retains some of that industrial character today, illustrating the seriousness of the pollution accumulated in the waterbody over the last 150 years. The contaminants were generated from changing industries such as oil refineries, fertilizer and glue factories, sawmills, and commercial ships. Regrettably, the city also contributed to this pollution by dumping raw sewage into the water as early as 1856.<span class='credit'>Image Credit: <a href='https://qns.com/story/2018/03/31/dirty-yet-important-history-newtown-creek-neighborhood-way/'>qns</a></span></span></span>",
            location: {},
            onChapterEnter: [],
            onChapterExit: []
        },
